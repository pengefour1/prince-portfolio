  ...
  return (
    <div>
      <div className='home__data'>
        <h1 className='home__title'>Prince Rajasekaran
            {/* <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className='home__description'>I'm a Full stack developer passionate about building solutions</p>
        <a href="mailto:pengefour1@gmail.com" className="button button--flex">
            Say Hello
            <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
